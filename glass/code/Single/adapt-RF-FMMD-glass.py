...
for i, cluster_id in enumerate(range(0,ncluster)):
    ...
    adapt_model= fMMD(estimator = RandomForestClassifier(n_estimators=100, max_depth=10),
           Xt=Xt, threshold='auto', kernel='linear', gamma=1.0, degree=2, coef=1.0, copy=True, verbose=1, random_state=None
        )
