# -*- coding: utf-8 -*-
"""adapt-RF-PRED-glass-cluster.ipynb
...
for i, cluster_id in enumerate(range(0,ncluster)):
    ...
    adapt_model= PRED(estimator = RandomForestClassifier(n_estimators=100, max_depth=10),
       Xt=Xt.iloc[:n], yt=yt[:n], copy=True, pretrain=True, verbose=1, random_state=None)
