# -*- coding: utf-8 -*-
"""adapt-RF-FA-glass-cluster.ipynb
...
for i, cluster_id in enumerate(range(0,ncluster)):
    ...
    adapt_model= FA(estimator = RandomForestClassifier(n_estimators=100, max_depth=10),
       Xt=Xt.iloc[:n], yt=yt[:n], copy=True, verbose=1, random_state=None)
